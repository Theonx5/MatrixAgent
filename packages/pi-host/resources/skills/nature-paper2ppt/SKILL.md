...
4. Figures live in a sibling `images/` folder. Use those files as slide assets. If a file is missing, say it was not synced.
...
The end product is a real `.pptx` deck, not an outline or script. Do not fabricate results, numbers, or figure details. Prefer the paper's sibling `images/` files over PDF crops.
