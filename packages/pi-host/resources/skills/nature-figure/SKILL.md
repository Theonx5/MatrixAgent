...
4. When revising or matching a paper figure, `read` the sibling `images/` files first. Write new figures to `notes/` or `reviews/`, never into the synced `images/` folder.
