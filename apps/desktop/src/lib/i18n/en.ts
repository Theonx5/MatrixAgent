...
export const en = {
  ...
  shortcutsSubtitle: "Customize commands active while PaperMatrix is focused",
  ...
  settingsSubtitle: "Configure PaperMatrix and its runtime",
  settingsBack: "Back to conversation",
  navGeneral: "General",
  navAppearance: "Appearance",
  navMatrix: "Paper Matrix",
  ...
  // Appearance
  appearanceSubtitle: "Theme, density, language, and typography",
  ...
  appearanceDensityDesc: "Adjust row, control, and list spacing across PaperMatrix.",
  appearanceDensityCompact: "Compact",
  appearanceDensityStandard: "Standard",
  appearanceDensityComfortable: "Comfortable",
  appearanceUiFontSize: "Interface font size",
  appearanceUiFontSizeDesc: "Text size for sidebars, settings, and other chrome.",
  ...
  generalLanguageDesc: "Language of the PaperMatrix interface.",
  ...
  hostUpdateUpToDate: "PaperMatrix is up to date.",
  ...
  packagesRemoveWarning:
    "This removes the package and its resources from the Agent. Removal cannot be undone from PaperMatrix.",
  ...
  composerLoginGuidance:
    "PaperMatrix manages credentials in Settings — choose a provider and sign in there.",
  ...
  matrixAccountGroup: "Account",
  matrixUsername: "Username",
  matrixPassword: "Password",
  matrixRememberPassword: "Remember password",
  matrixRememberPasswordDesc: "Store the password in the OS keychain for silent re-login.",
  matrixLogin: "Log in",
  matrixLogout: "Log out",
  matrixLoggedInAs: "Signed in as {name}",
  matrixRole: "Plan: {role}",
  matrixSyncGroup: "Library sync",
  matrixSyncNow: "Sync now",
  matrixSyncing: "Syncing…",
  matrixLastSync: "Last sync: {time}",
  ...
  matrixProgress: "{done} / {total} papers",
  matrixLoginFailed: "Paper Matrix login failed",
  matrixSyncFailed: "Paper Matrix sync failed",
  matrixPickLibraryFailed: "Could not choose a library folder",
  chatMatrixLoginTitle: "Connect Paper Matrix to use your library",
  chatMatrixLoginAction: "Open Paper Matrix",
